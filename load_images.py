...
train_images_count = int(5/6*len(images))
train_images = images[:train_images_count]
print("Length of train_images", len(train_images))
with open("train_images", "wb") as f:
	pickle.dump(train_images, f)
del train_images

train_labels = labels[:train_images_count]
...
test_labels = labels[train_images_count:]
